...
export default function aboutUs() {
    const profiles = [
        ...
        },
        {
            key: 2,
            img: chobhee,
            name: 'นางสาวกัญญารัตน์ ไชยยันต์บูรณ์',
            id: '64010037',
            job: '(Full-stack)',
        },
        {
                ...
                {profiles.map((profile) => {
                    return (
                        <div
                            ...
                            key={profile.key}
                        >
                            <div className="absolute top-[-150px] right-[-150px] rotate-[20deg] scale-[.35]">
                                <img src={burger} />
                            </div>
                            <img src={profile.img} className="mx-auto h-60" />
                            <h1 className="mt-2 font-Kanit font-bold">
                                {profile.name}
                            </h1>
                            <h1 className="font-Kanit font-medium">
                                {profile.id}
                            </h1>
                            <h1 className="font-Kanit font-light">
                                {profile.job}
                            </h1>
                        </div>
                    )
